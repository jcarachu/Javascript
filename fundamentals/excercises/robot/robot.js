...
// Describes a route for every parcel
function lazyRobot({place, parcels}, route)
{
	if (route.length == 0)
	{
		...
		// Determines the precedence a route.
...
function compareRobots(robot1, memory1, robot2, memory2)
{
	...
	console.log(`Robot 1 needed ${total1 / 100} steps per tasks`);
...
console.log("*** CompareRobot ***");
compareRobots(routeRobot, [], goalOrientedRobot, []);
console.log("*** RobotEfficiency ***");
